...
if (message.content === '2help') {
       ...
       .addField("**1givaway**","**اذا تبي تسوي قيف اواي سوي الخطوات الاتية اول شي اكتب الامر وبعدين اكتب اسم الروم يللي تبي يصير فيه القيف اواي وبعدين رح يطلب منك مدة القيف اواي اكتب المدة بالدقائق يعني مثلا اكتب بس 1 كذا يصيرمدة اليقف الاواي بس دقيقة ما ضروري تكتب المدة بس رقم وبس بالدقائق**")
